...
namespace WebApiAutores.Middlewares
{
    ...
    {
        public static IApplicationBuilder UseLoguearRespuestaHTTP(this IApplicationBuilder application)
        {
            return application.UseMiddleware<LoguearRespuestaHTTPMiddleware>();
        }
    }
