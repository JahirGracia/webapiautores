...
namespace WebApiAutores.Controllers
{
    ...
    public class ComentariosController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<ComentarioDTO>>> Get(int libroId, [FromQuery] PaginacionDTO paginacionDTO)
        {
            ...
            // Configuramos la paginacion de los comentarios
        ...
        [HttpGet("{id:int}", Name = "obtenerCoementario")]
        ...
        public async Task<ActionResult> Post(int libroId, ComentarioCreacionDTO comentarioCreacionDTO)
        {
            ...
            //return Ok();
            return CreatedAtRoute("obtenerCoementario", new { id = comentario.Id, libroId = libroId }, comentarioDTO);
